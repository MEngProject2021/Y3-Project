...
class Task(models.Model):
    ...
    file_type = models.CharField(max_length=255, null=True, blank=True, help_text=_("A label for the file type"), verbose_name=_("File Type"))
    ...
    def get_hyperspectral_display_params(self):
        """
    ...
    def resize_images(self):
        ...
        if self.resize_to < 0:
            ...
            return []
        print("Start resize", file=sys.stderr)
