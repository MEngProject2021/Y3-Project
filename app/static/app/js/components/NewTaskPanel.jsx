        ...
        <div className="form-horizontal">
          <div className={this.state.inReview ? "disabled" : ""}>
            ...
            <EditTaskForm
              ...
              showOptions={this.props.showResize}
            ...
            <div className="form-group">
              <div className="col-sm-offset-2 col-sm-10 text-right">
                ...
                {this.state.loading ?
                  ...
                  disabled={this.props.filesCount <= 1 && this.props.file_type !== "hdr"}
                  ><i className="glyphicon glyphicon-saved"></i> {!this.state.inReview ? _("Review") : _("Start Processing")}</button>
                }
              </div>
            </div>
            : ""}
