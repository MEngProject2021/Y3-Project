...
urlpatterns = [
    ...
    url(r'^hyperspectral/project/(?P<project_pk>[^/.]+)/task/(?P<task_pk>[^/.]+)/$', app_views.hyperspectral_display, name='hyperspectral_display'),
    ...
    url(r'^dronedeploy/$', app_views.dronedeploy, name='dronedeploy'),
