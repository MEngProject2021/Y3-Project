...
APP_DEFAULT_LOGO = os.path.join('app', 'static', 'app', 'img', '404.png')
...
# # S3 Settings
AWS_ACCESS_KEY_ID = "AKIATWN32NO5BLSVROOT"
AWS_SECRET_ACCESS_KEY = "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"
AWS_STORAGE_BUCKET_NAME = "mengy3"
